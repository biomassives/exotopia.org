...
<style scoped>
/* ── Page ─────────────────────────────────────────────────────────────────── */
.dp-page { background: #020408; min-height: 100vh; font-family: 'Courier New', monospace; display: flex; flex-direction: column; }
...
.dp-nav {
  ...
  background: rgba(0,4,14,0.90); border-right: 1px solid rgba(0,70,120,0.20);
  overflow-y: auto; padding: 12px 0 40px;
  scrollbar-width: thin; scrollbar-color: rgba(0,100,160,0.20) transparent;
...
/* ── Content ──────────────────────────────────────────────────────────────── */
.dp-content {
  flex: 1; overflow-y: auto; padding: 32px 48px 80px;
  scrollbar-width: thin; scrollbar-color: rgba(0,100,160,0.20) transparent;
}
