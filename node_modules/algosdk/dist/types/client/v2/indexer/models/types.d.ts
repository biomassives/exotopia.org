 ...
 *
 */
export declare class BlockHeadersResponse extends BaseModel {
    blocks?: Block[];
    /**
     * Round at which the results were computed.
     */
    ...
    static from_obj_for_encoding(data: Record<string, any>): BlockHeadersResponse;
}
/**
 * Fields relating to rewards,
 */
 ...
 * it is online.
 */
export declare class HbProofFields extends BaseModel {
    /**
 ...
 * data/transactions/heartbeat.go : HeartbeatTxnFields
 */
export declare class TransactionHeartbeat extends BaseModel {
    /**
    ...
    static from_obj_for_encoding(data: Record<string, any>): TransactionHeartbeat;
}
/**
 * Fields for a keyreg transaction.
 * Definition:
