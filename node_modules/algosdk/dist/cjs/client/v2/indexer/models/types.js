 ...
 *
 */
class BlockHeadersResponse extends basemodel_1.default {
    /**
 ...
 * it is online.
 */
class HbProofFields extends basemodel_1.default {
    /**
    ...
    constructor({ hbPk, hbPk1sig, hbPk2, hbPk2sig, hbSig, }) {
        ...
        this.hbPk =
            typeof hbPk === 'string'
                ? new Uint8Array(buffer_1.Buffer.from(hbPk, 'base64'))
                : hbPk;
        this.hbPk1sig =
            typeof hbPk1sig === 'string'
                ? new Uint8Array(buffer_1.Buffer.from(hbPk1sig, 'base64'))
                : hbPk1sig;
        this.hbPk2 =
            typeof hbPk2 === 'string'
                ? new Uint8Array(buffer_1.Buffer.from(hbPk2, 'base64'))
                : hbPk2;
        this.hbPk2sig =
            typeof hbPk2sig === 'string'
                ? new Uint8Array(buffer_1.Buffer.from(hbPk2sig, 'base64'))
                : hbPk2sig;
        this.hbSig =
            typeof hbSig === 'string'
                ? new Uint8Array(buffer_1.Buffer.from(hbSig, 'base64'))
                : hbSig;
        this.attribute_map = {
            hbPk: 'hb-pk',
            hbPk1sig: 'hb-pk1sig',
 ...
 * data/transactions/heartbeat.go : HeartbeatTxnFields
 */
class TransactionHeartbeat extends basemodel_1.default {
    /**
    ...
    constructor({ hbAddress, hbKeyDilution, hbProof, hbSeed, hbVoteId, }) {
        ...
        this.hbSeed =
            typeof hbSeed === 'string'
                ? new Uint8Array(buffer_1.Buffer.from(hbSeed, 'base64'))
                : hbSeed;
        this.hbVoteId =
            typeof hbVoteId === 'string'
                ? new Uint8Array(buffer_1.Buffer.from(hbVoteId, 'base64'))
                : hbVoteId;
        this.attribute_map = {
