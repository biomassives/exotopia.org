...
export const COSMIC_EVENTS: CosmicEvent[] = [
  {
    ...
    community:    'OT Kulcha',
    type:         'sound-session',
    description:  'Live hybrid reggae production session. Streaming via pon.ink with real-time virtual attendance at the cluster settlement dome. Airdrop of $BARS soundbank NFT to attendees.',
  ...
  },
  {
    ...
    community:    'Fana Ka',
    type:         'live-event',
    description:  'Rap battle event with street media broadcast. Participants compete from their virtual settlement domes. Judges vote via pon.ink. $BARS airdrop to top 3.',
