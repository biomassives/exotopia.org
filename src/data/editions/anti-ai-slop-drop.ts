...
export const ANTI_AI_CARDS: CollectorCard[] = [
...

  {
    ...
    description: 'The fingerprint of someone who builds. Calluses form at the point of repeated contact with a tool — the guitar string, the water pump handle, the shovel grip. Proof of practice. No model has calluses.',
    bgFrom: '#0e0400', bgTo: '#180700',
    borderColor: '#4488ff', glowColor: 'rgba(220,100,60,0.42)',
    artColors: ['#cc6633', '#aa4411', '#ee9966', '#331100', '#ffddcc'],
    attributes: [
      { trait_type: 'Series',   value: 'Anti-AI Slop Drop' },
      { trait_type: 'Edition',  value: '5 of 11' },
      { trait_type: 'Rarity',   value: 'Rare' },
      { trait_type: 'Form',     value: 'Fingerprint / dermoglyphics' },
      { trait_type: 'Evidence', value: 'Repeated manual contact' },
      { trait_type: 'Tool',     value: 'Water pump handle, instrument neck' },
    ],
  },
